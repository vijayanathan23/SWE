...
<div class="log">
	...
	<div class="box1">
			...
			<h1 style="text-align:center;padding-top:15px;font-size:35px;">HEY USER ! </h1>
        ...
        <input type="hidden" name="loginType" value="customer">
			...
			<p style="color: white;">
            	...
            	<p style="margin-left:35px";>New user ?  <a style="color: white;"href="user_reg.php">Sign Up</a></p>
            </p>
